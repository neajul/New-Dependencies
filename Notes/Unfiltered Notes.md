...
* what happens beyond the blinking lights of our router? who knows
  * interestingly in a network diagram we draw this as a cloud
  * and that is how we see it: everyone understands they have a router and things connect to it, so the internal diagram everyone understands, but beyond that is just "the cloud"
